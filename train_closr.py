...
def parse_option():
    ...
    # loss config
    parser.add_argument('--margin', type=float, default=0.2, help='loss function margin value')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.0403709 , help='weight decay')
